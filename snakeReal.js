class Game {
    ...
    init(){
        ...
        this.director = setInterval(() => {
            ...
            this.ctx.drawImage(this.lose, 0 , 0, this.canvas.width, this.canvas.height);
            }
        }, 100);
    ...
    show(){
        ...
        this.snake.map((square, index) => {
            ...
            if (index == 0){
                this.ctx.drawImage(this.head, square.X * this.sizeSquare,
                    square.Y * this.sizeSquare, this.sizeSquare, this.sizeSquare)
            }else{
                this.ctx.drawImage(this.tail, square.X * this.sizeSquare,
                    square.Y * this.sizeSquare, this.sizeSquare, this.sizeSquare)
            }

            if (this.food != null){
                this.ctx.drawImage(this.cookie, this.food.X * this.sizeSquare,
                    this.food.Y * this.sizeSquare, this.sizeSquare, this.sizeSquare)
            }


            // Update UI element with current score
